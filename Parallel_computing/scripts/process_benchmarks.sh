...
files=("test_time/serial.time" "test_time/p10.time" "test_time/p25.time" "test_time/p50.time" "test_time/p100.time")
procs=(1 10 25 50 100)

# Output CSV file
output="test_time/benchmark_results.csv"
